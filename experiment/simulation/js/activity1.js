...
function a1_draw_all_components() {
    var sq = new Chemistry.Custome_image(cv_meter, new Chemistry.Point(700, 200), 329, 236, canvas);
    sq.name = 'Current/Voltage Meter';
    scene.add(sq);
    var sq = new Chemistry.Custome_image(electromagnet, new Chemistry.Point(1500, 200), 666, 233, canvas);
    sq.name = 'Electromagnet';
    scene.add(sq);
    var sq = new Chemistry.Custome_image(em_supply, new Chemistry.Point(1650, 700), 388, 287, canvas);
    sq.name = 'Electromagnet Power Supply';
    scene.add(sq);
    var sq = new Chemistry.Custome_image(gauss_meter, new Chemistry.Point(800, 700), 329, 236, canvas);
    sq.name = 'Gauss Meter';
    scene.add(sq);
    var sq = new Chemistry.Custome_image(gauss_probe, new Chemistry.Point(150, 220), 273, 248, canvas);
    sq.name = 'Gauss Probe';
    scene.add(sq);
    var sq = new Chemistry.Custome_image(hall_probe, new Chemistry.Point(230, 700), 297, 273, canvas);
    sq.name = 'Hall Probe';
    scene.add(sq);
    var sq = new Chemistry.Custome_image(wooden_Stand, new Chemistry.Point(1200, 550), 147, 156, canvas);
...
function a1_load_questions() {
    ...
    question.push({
        srno: 1,
        question: "Select <span style='color: #018fc3'> Current/Voltage Meter </span>",
...
function load_higlighted_images() {
    ...
    a1_labels = [
        new Chemistry.Text('Current/Voltage Meter', new Chemistry.Point(590, 50), canvas),
        new Chemistry.Text('Electromagnet', new Chemistry.Point(1400, 50), canvas),
        new Chemistry.Text('Electromagnet Power Supply', new Chemistry.Point(1500, 520), canvas),
        new Chemistry.Text('Gauss Meter', new Chemistry.Point(730, 550), canvas),
        ...
        new Chemistry.Text('Wooden Stand', new Chemistry.Point(1130, 440), canvas),
    ];
