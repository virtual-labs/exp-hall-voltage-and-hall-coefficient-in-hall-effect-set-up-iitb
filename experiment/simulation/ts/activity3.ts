...
function select_dataset() {
    let first_dd: HTMLSelectElement = <HTMLSelectElement> document.getElementById('first-dd'); 
    let img_container: HTMLDivElement = <HTMLDivElement> document.getElementById('act-spec-img');
...
function select_current() {
    let i_slider: HTMLInputElement = <HTMLInputElement> document.getElementById('current-slider');
    let show_i: HTMLInputElement = <HTMLInputElement> document.getElementById('show-current');
    let show_mfield: HTMLInputElement = <HTMLInputElement> document.getElementById('show-mfield');
...
function set_m2(num: number) {
    if(num == 2) {
        let material_ele: HTMLSelectElement = <HTMLSelectElement> document.getElementById('a3-m2-2');
        ...
        let thickness_ele: HTMLSelectElement = <HTMLSelectElement> document.getElementById('a3-m2-3');
        ...
        let current_ele: HTMLSelectElement = <HTMLSelectElement> document.getElementById('a3-m2-4');
        if(current_ele.value != '') {
            selected_field_current = parseInt(current_ele.value);
            let btn: HTMLButtonElement = <HTMLButtonElement> document.getElementById('a3-btn-2');
            btn.disabled = false;
...
function a3_show_slider() {
    let btn: HTMLButtonElement = <HTMLButtonElement> document.getElementById('a3-btn-2');
    let m2_slider: HTMLInputElement = <HTMLInputElement> document.getElementById('m2-slider');
...
function show_m2() {
    ...
    let slider1: HTMLInputElement = <HTMLInputElement> document.getElementById("m2-slider1");
    let show1: HTMLInputElement = <HTMLInputElement> document.getElementById("current-m2-inp");
    let show2: HTMLInputElement = <HTMLInputElement> document.getElementById("b-m2-inp");
    let show3: HTMLInputElement = <HTMLInputElement> document.getElementById("fi-m2-inp");
    ...
    let btn:HTMLButtonElement = <HTMLButtonElement> document.getElementById("m2-a3-a4");
    btn.disabled = false;
...
function set_m3(num: number) {
    if(num == 2) {
        let material_ele: HTMLSelectElement = <HTMLSelectElement> document.getElementById('a3-m3-2');
        if(material_ele.value != '') {
        ...
        let thickness_ele: HTMLSelectElement = <HTMLSelectElement> document.getElementById('a3-m3-3');
        if(thickness_ele.value != '') {
        ...
        let current_ele: HTMLSelectElement = <HTMLSelectElement> document.getElementById('a3-m3-4');
        if(current_ele.value != '') {
            selected_field_current_m3 = parseInt(current_ele.value);
            selected_field_current = selected_field_current_m3;
            let btn: HTMLButtonElement = <HTMLButtonElement> document.getElementById('a3-m3-btn-2');
...
function a3_m3_show_slider() {
    let btn: HTMLButtonElement = <HTMLButtonElement> document.getElementById('a3-m3-btn-2');
    let m2_slider: HTMLInputElement = <HTMLInputElement> document.getElementById('m3-slider');
...
function show_m3() {
    ...
    let slider1: HTMLInputElement = <HTMLInputElement> document.getElementById("m3-slider1");
    let show1: HTMLInputElement = <HTMLInputElement> document.getElementById("current-m3-inp");
    let show3: HTMLInputElement = <HTMLInputElement> document.getElementById("fi-m3-inp");
    ...
    let btn:HTMLButtonElement = <HTMLButtonElement> document.getElementById("m3-a3-a4");
    btn.disabled = false;
}
